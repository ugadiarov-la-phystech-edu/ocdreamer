...
from embodied.torch.ocr.slotcontrast.modules import networks, utils
from embodied.torch.ocr.slotcontrast.modules.utils import Conv2dBlock, conv2d, PositionalEmbedding
from embodied.torch.ocr.slotcontrast.utils import config_as_kwargs, make_build_fn
